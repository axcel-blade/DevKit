...
DevKit **0.3.0** is a CLI application with a plugin pipeline.
...
Plugins are plain Python classes. No separate package index in 0.3.0 — add modules under `src/devkit/plugins/`.
