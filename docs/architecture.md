...
DevKit **0.5.0** is a CLI application with a plugin pipeline.
...
Plugins are plain Python classes. No separate package index in 0.5.0 — add modules under `src/devkit/plugins/`.
